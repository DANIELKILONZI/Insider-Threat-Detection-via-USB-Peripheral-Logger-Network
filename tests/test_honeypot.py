...
from server.honeypot import is_honeypot_device, HoneypotConfig
from server.rules import rule_honeypot_device
...
def test_honeypot_rule_fires_on_match():
    with patch("server.honeypot._honeypot_config") as mock_cfg:
